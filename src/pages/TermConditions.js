...
import '../components/pageSections/termConditions/TermConditions.css'
	...
	return (
		<div className='containerTermCond'>
			...
			<p>
				...
				Proveedor de cada publicación. En lo sucesivo encontrarás los Términos y
				Condiciones aplicables a todos los Usuarios; clientes y proveedores.
				<br />
				<br /> Al usar o visitar la aplicación, manifiestas tu conformidad y te
				obligas con estos términos y condiciones, así como de todas las leyes y
				...
				Como cliente: <br />
				<br />
				Para el uso de la aplicación, es necesaria la creación de un usuario,
				por la que deberás proporcionar la siguiente información obligatoria: Un
				solo Nombre, Correo electrónico, contraseña y tipo se usuario, de forma
				opcional se solicita un apellido. <br />
				<br />
				...
				Como proveedor: <br />
				<br />
				Para la compra de un mes o suscripción se requieren los mismos datos
				antes mencionados. Los datos de la tarjeta de crédito o débito o el
				...
				<br />
				<br />
				En caso de olvidar tu contraseña, podrás recuperarla dando clic en
				...
				cualquier otro proceso automatizado en el sitio. Las violaciones de
				...
				Derechos de Autor
				<br />
				<br /> Está prohibido que cualquier usuario que use esta plataforma o
				aplicación, transmita o comparta ilegalmente cualquier información con
				derechos de autor sin previo consentimiento expreso de licencia, defensa
				válida o exención de uso justo para hacerlo. En particular, los usuarios
				que difundan el contenido de esta plataforma o aplicación, ya sean
				artículos, imágenes, o cualquier otro material con derechos de autor;
				deben de asegurarse que no infringe ningún derecho de autor o cualquier
				otro derecho de terceros (incluyendo, más no limitándose a, marcas
				registradas, secretos comerciales, derechos de privacidad o publicidad).
				En caso de que el usuario incumpliera este párrafo, se obliga a sacar en
